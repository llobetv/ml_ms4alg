...
def mountainsort4(recording,detect_sign=0,clip_size=50,adjacency_radius=-1,detect_threshold=3,detect_interval=10,
  ...
  tmpdir = tempfile.mkdtemp(dir=os.environ.get('ML_PROCESSOR_TEMPDIR','/tmp'))
